...
export const HeroSection = () => {
  return (
    <div className='flex justify-center items-center sm:px-16 px-6 sm:pb-16 xs:pb-8 pb-12 lg:pt-6 pt-[80px] hero-section-height overflow-x-hidden' id='hero-section'>
