...
export const HeroSectionText: FC = () => {
  ...
  return (
    <motion.div
      className="flex flex-1 flex-col justify-center sm:items-start items-center"
      initial={animateHeroSectionLeftInitialState}
      animate={controls as AnimationControls}
      ref={ref as RefUseAnimate["ref"]}
    >
      <p className="sm:text-[20px] text-[16px] sm:leading-[27px] leading-[23px] font-semibold text-yellow-600 mb-5">
        {supTitle}
      </p>
      <h1 className="text-white font-bold md:text-[64px] md:leading-[70px] leading-[46px] text-[40px]  tracking-[-0.5%] sm:text-left text-center">
        {title} <span className="text-gradient-h1">{subTitle}</span>
      </h1>
      <p className="sm:text-[20px] text-[16px] sm:leading-[27px] leading-[23px] mt-5 mb-10 font-normal text-[#d1cccce2] sm:text-left text-center">
